...
public class AlunoDAO {
    ...
    public static List<Aluno> getAllStudent(){
    ...
    public static void newStudent(Aluno alunoParam){
        ...
        try {
            ...
            PreparedStatement ps = null;
             ps = con.prepareStatement("INSERT INTO alunos (Name, RG, CPF, birthCertificate, birthDate, MobilePhone,reponsavelMae,RGMae, CPFMae, responsavelPai, RGPai, CPFPai, mobilePhone, Phone, Mail, CEP, Address, Number, District, City, UF, birthCity, isMatriculado, ForeignKeyClass) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
